<?php
/**
 * GitHub-backed updater bootstrap for Foundation: Content Onboard.
 */
...
final class FCO_Github_Updater {
	/**
	 * Singleton instance.
	 *
	 * @var FCO_Github_Updater|null
	 */
	...
	public function boot() {
		...
		$loader = FCO_PLUGIN_DIR . 'plugin-update-checker/plugin-update-checker.php';
		...
		try {
			...
			if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
				error_log( 'Foundation Content Onboard updater error: ' . $exception->getMessage() ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_error_log
			}
		}
	}
	...
	private function get_plugin_slug() {
		return dirname( plugin_basename( FCO_PLUGIN_FILE ) );
	}
}
